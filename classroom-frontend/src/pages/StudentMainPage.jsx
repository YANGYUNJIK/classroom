...
//   const [aiLoading, setAiLoading] = useState(true); // ✅ GPT 로딩 여부
//   const [recentEvalTitle, setRecentEvalTitle] = useState(""); // ✅ 최근 평가 제목
...
//       setAiAdvice(res.data.message); // 예: { message: "코칭 문구", title: "제목" }
//       setRecentEvalTitle(res.data.title || ""); // 최근 평가 제목
//     } catch (err) {
//       console.error("AI 학습 코칭 불러오기 실패", err);
//       setAiAdvice("❌ AI 학습 코칭을 불러오지 못했습니다.");
//     } finally {
//       setAiLoading(false);
//     }
//   };
...
//           안녕하세요,{" "}
//           <span className="font-semibold text-gray-800">{name}</span>님!
//         </p>
//         <div className="text-sm text-gray-600 mb-4">
//           학교: <b>{school}</b> / 학년: <b>{grade}</b> / 반: <b>{classNum}</b>
//         </div>
...
//             <p className="text-sm text-gray-700 mt-2">불러오는 중...</p>
//           </div>
//         ) : aiAdvice ? (
//           <div className="mt-4 bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded shadow">
//             <p className="font-semibold text-yellow-800">📚 AI 학습 코칭</p>
